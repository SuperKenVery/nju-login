...
本项目要做的就是帮你跳过第三步。如果你访问统一认证网站时带上了有效的`CASTGC` cookie，那么它就会知道你已经登陆，并直接给你ticket然后带你重定向。
...
本项目自定义的错误都在[`src/nju_login/nju_login.py`]中定义了：
